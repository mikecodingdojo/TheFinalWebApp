...
class Upload(models.Model):
    ...
    imgpost = models.ForeignKey(User, related_name='user_photo', on_delete=models.CASCADE)
...
class UploadProfile(models.Model):
    ...
    created_at = models.DateTimeField(auto_now=True)
    updated_at = models.DateTimeField(auto_now_add=True)
    user = models.OneToOneField(User, on_delete=models.CASCADE, primary_key=True, default=None, related_name="profile_picture")